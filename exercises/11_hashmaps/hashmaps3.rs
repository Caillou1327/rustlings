...
fn build_scores_table(results: String) -> HashMap<String, Team> {
    ...
    for r in results.lines() {
        ...
        // team_1.
            // Mettre à jour le nombre de buts marqués par l'équipe 1 et le nombre de buts concédés par l'équipe 2.
            let team_1 = scores.entry(team_1_name.clone()).or_insert(Team { goals_scored: 0, goals_conceded: 0 });
            team_1.goals_scored += team_1_score;
            team_1.goals_conceded += team_2_score;
            
            // Mettre à jour le nombre de buts marqués par l'équipe 2 et le nombre de buts concédés par l'équipe 1.
